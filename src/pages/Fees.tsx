...
export function Fees() {
  const drivingFees = [{
    ...
    both: 'KSh 12,000',
    duration: '4-6 weeks',
    includes: ['Road signs training', 'Highway code', '10 practical lessons', 'Test preparation']
  }, {
    ...
    both: 'KSh 16,000',
    duration: '6-8 weeks',
    includes: ['Road signs training', 'Highway code', '15 practical lessons', 'Defensive driving', 'Test preparation']
  }, {
    ...
    both: 'KSh 19,000',
    duration: '8-10 weeks',
    includes: ['Road signs training', 'Highway code', 'Commercial vehicle regulations', '15 practical lessons', 'Load handling', 'Test preparation']
  }, {
    ...
    includes: ['Road signs training', 'Highway code', 'PSV regulations', '20 practical lessons', 'Passenger safety', 'Test preparation']
  }, {
    ...
    both: 'KSh 10,000',
    duration: '3-4 weeks',
    includes: ['Road signs training', 'Highway code', '8 practical lessons', 'Business use training', 'Test preparation']
  }];
  const computerFees = [{
    ...
    advanced: 'KSh 12,000',
    duration: '4 weeks',
    includes: ['Word', 'Excel', 'PowerPoint', 'Outlook', 'Certificate upon completion', 'Practice materials']
  }, {
    course: 'Basic IT & Networking',
    basic: 'KSh 10,000',
    advanced: 'KSh 15,000',
    duration: '6 weeks',
    includes: ['Computer hardware', 'Operating systems', 'Network setup', 'Troubleshooting', 'Certificate upon completion']
  }, {
    course: 'Graphic Design Fundamentals',
    basic: 'KSh 12,000',
    advanced: 'KSh 18,000',
    duration: '8 weeks',
    includes: ['Design principles', 'Basic software skills', 'Project portfolio', 'Certificate upon completion']
  }];
  const specialCourses = [{
    course: 'First Aid Training',
    fee: 'KSh 5,000',
    duration: '2 weeks',
    includes: ['Emergency response', 'CPR training', 'Wound care', 'Certificate upon completion']
  }, {
    course: 'Basic Mechanics',
    fee: 'KSh 7,000',
    duration: '3 weeks',
    includes: ['Vehicle maintenance', 'Troubleshooting', 'Emergency repairs', 'Certificate upon completion']
  }];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-5xl overflow-x-auto">
            <table className="w-full border-collapse rounded-lg bg-white shadow-sm">
              ...
              <tbody>
                {drivingFees.map((fee, index) => <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-4xl overflow-x-auto">
            <table className="w-full border-collapse rounded-lg bg-white shadow-sm">
              ...
              <tbody>
                {computerFees.map((fee, index) => <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    <td className="border-b border-gray-200 px-4 py-3 font-medium">
                      {fee.course}
                    </td>
                    <td className="border-b border-gray-200 px-4 py-3">
      ...
      <section className="bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-2">
            {specialCourses.map((course, index) => <div key={index} className="rounded-lg bg-white p-6 shadow-sm">
                ...
                <ul className="mb-6 space-y-2">
                  {course.includes.map((item, i) => <li key={i} className="flex items-center text-gray-600">
                ...
                <Button variant="outline" to="/booking" className="w-full">
                  Enroll Now
                </Button>
              </div>)}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-3xl overflow-x-auto">
            <table className="w-full border-collapse rounded-lg bg-white shadow-sm">
              ...
              <tbody>
                {additionalServices.map((service, index) => <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    <td className="border-b border-gray-200 px-4 py-3">
                      {service.service}
                    </td>
