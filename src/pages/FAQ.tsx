        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              {faqItems.map((faq, index) => <FAQItem key={index} question={faq.question} answer={faq.answer} isOpen={openIndex === index} toggleOpen={() => toggleFAQ(index)} />)}
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
              {/* This would contain actual road sign images and descriptions */}
              {[1, 2, 3, 4, 5, 6, 7, 8].map(index => <div key={index} className="flex flex-col items-center rounded-lg bg-white p-4 text-center shadow-sm">
                  <div className="mb-3 h-16 w-16 rounded-full bg-gray-200"></div>
                  <p className="text-sm font-medium text-gray-800">
                    Road Sign Example {index}
                  </p>
                </div>)}
            </div>
            <div className="mt-8 text-center">
