      ...
      <div className="bg-gray-800 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg">
            Get in touch with us for inquiries, bookings, or more information
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <MapPin className="mr-4 mt-1 flex-shrink-0 text-[#2E8B57]" size={24} />
                    <div>
                  ...
                  <div className="flex items-start">
                    <Phone className="mr-4 mt-1 flex-shrink-0 text-[#2E8B57]" size={24} />
                    <div>
                      <h3 className="mb-1 text-lg font-medium text-gray-800">
                        Phone
                      </h3>
                  ...
                  <div className="flex items-start">
                    <Mail className="mr-4 mt-1 flex-shrink-0 text-[#2E8B57]" size={24} />
                    <div>
                      <h3 className="mb-1 text-lg font-medium text-gray-800">
                        Email
                      </h3>
                  ...
                  <div className="flex items-start">
                    <Clock className="mr-4 mt-1 flex-shrink-0 text-[#2E8B57]" size={24} />
                    <div>
                      <h3 className="mb-1 text-lg font-medium text-gray-800">
                        Working Hours
                      </h3>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-colors hover:bg-[#2E8B57] hover:text-white" aria-label="Facebook">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                      </svg>
                    </a>
                    <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-colors hover:bg-[#2E8B57] hover:text-white" aria-label="Twitter">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>
                      </svg>
                    </a>
                    <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-colors hover:bg-[#2E8B57] hover:text-white" aria-label="Instagram">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select id="subject" name="subject" value={formData.subject} onChange={handleChange} required className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-[#2E8B57] focus:outline-none focus:ring-1 focus:ring-[#2E8B57]">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-6 text-center">
              <Button variant="outline" href="https://www.google.com/maps?q=Eldoret+Roadblock">
                View Larger Map
              </Button>
            </div>
          </div>
