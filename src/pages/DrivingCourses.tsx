...
export function DrivingCourses() {
  const courses = [{
    ...
    category: 'Driving',
    description: 'Practical training and theory for safe motorcycle operation, hazard avoidance, and road rules.',
    duration: '4-6 weeks',
    prerequisites: '18+ years, ID/Passport',
    imageUrl: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
  }, {
  ...
  const benefits = [{
    ...
    description: 'Our curriculum emphasizes defensive driving techniques to keep you and others safe on the road.'
  }, {
    icon: <Users size={24} />,
    title: 'Experienced Instructors',
    description: 'Learn from certified instructors with years of professional driving and teaching experience.'
  }, {
    icon: <Clock size={24} />,
    title: 'Flexible Scheduling',
    description: 'Choose from morning, afternoon, or evening sessions to fit your busy schedule.'
  }, {
    icon: <Award size={24} />,
    title: 'Recognized Certification',
    description: 'Receive a certificate that is recognized by employers and authorities across Kenya.'
  }];
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              {benefits.map((benefit, index) => <div key={index} className="rounded-lg bg-gray-50 p-6 text-center">
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {courses.map((course, index) => <CourseCard key={index} title={course.title} category={course.category} description={course.description} duration={course.duration} prerequisites={course.prerequisites} imageUrl={course.imageUrl} />)}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-4xl overflow-x-auto">
            <table className="w-full border-collapse rounded-lg shadow-sm">
              ...
              <tbody>
                {pricingData.map((price, index) => <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    <td className="border-b border-gray-200 px-4 py-3 font-medium">
                      {price.category}
                    </td>
                    <td className="border-b border-gray-200 px-4 py-3">
      ...
      <section className="bg-[#2E8B57] py-12 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
            <Button variant="primary" to="/booking" className="bg-white/10 px-6 py-3 text-[#2E8B57] hover:bg-gray-100">
              Book a Lesson
            </Button>
