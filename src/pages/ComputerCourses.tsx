...
export function ComputerCourses() {
  const courses = [{
    ...
    category: 'Computer',
    description: 'Comprehensive training on Word, Excel, PowerPoint, and Outlook for professional document creation and data management.',
    duration: '4 weeks',
    ...
    category: 'Computer',
    description: 'Introduction to computer hardware, software, operating systems, and basic network configuration and troubleshooting.',
    duration: '6 weeks',
    prerequisites: 'None',
    ...
    category: 'Special',
    description: 'Essential first aid skills including CPR, wound care, and emergency response procedures for various situations.',
    duration: '2 weeks',
    prerequisites: 'None',
    ...
    category: 'Special',
    description: 'Fundamentals of vehicle mechanics including basic maintenance, troubleshooting, and emergency repairs.',
    duration: '3 weeks',
    prerequisites: 'None',
    imageUrl: 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
  }];
