...
import { Printer, PenTool, Globe, Settings, FileText, HelpCircle, Repeat, Award } from 'lucide-react';
export function Services() {
  const services = [{
    title: 'Printing Services',
    description: 'Regular, large format, and plotter printing for documents, posters, banners, and more.',
    icon: <Printer size={24} />
  }, {
    title: 'T-shirt & Branding',
    description: 'Custom t-shirt printing, branding materials, and promotional items for businesses and events.',
    icon: <PenTool size={24} />
  }, {
    title: 'Web Hosting & Design',
    description: 'Website design, hosting, and maintenance services for businesses and individuals.',
    icon: <Globe size={24} />
  }, {
    title: 'Software Installation',
    description: 'Professional software installation, updates, and troubleshooting for your devices.',
    icon: <Settings size={24} />
  }, {
    title: 'KRA Services',
    description: 'Assistance with KRA PIN registration, returns filing, and tax compliance matters.',
    icon: <FileText size={24} />
  }, {
    title: 'HELB Applications',
    description: 'Guidance and support with HELB loan applications and management.',
    icon: <HelpCircle size={24} />
  }, {
    title: 'Driving Licence Renewal',
    description: 'Simplified process for renewing your driving licence without the hassle.',
    icon: <Repeat size={24} />
  }, {
    title: 'eCitizen Services',
    description: 'Assistance with eCitizen registration and various government services applications.',
    icon: <Award size={24} />
  }];
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div className="flex items-center justify-center">
                <div className="overflow-hidden rounded-lg">
                  <img src="https://images.unsplash.com/photo-1588681664899-f142ff2dc9b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Printing services" className="h-auto w-full object-cover" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="order-2 md:order-1 flex items-center justify-center">
                <div className="overflow-hidden rounded-lg">
                  <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Government services" className="h-auto w-full object-cover" />
                </div>
              </div>
      ...
      <section className="bg-[#D7263D] py-12 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
            <Button variant="primary" to="/contact" className="bg-white text-[#D7263D] hover:bg-gray-100">
              Contact Us
            </Button>
            <Button variant="outline" href="tel:+254117564318" className="border-white text-white hover:bg-white/10">
