...
export function TestimonialCard({
  ...
  return <div className="flex flex-col rounded-lg bg-white p-6 shadow-sm">
      <div className="mb-4 text-[#2E8B57]">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="opacity-50">
      ...
      <div className="mt-auto flex items-center">
        {imageUrl ? <img src={imageUrl} alt={name} className="mr-4 h-12 w-12 rounded-full object-cover" /> : <div className="mr-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#2E8B57]/10 text-[#2E8B57]">
