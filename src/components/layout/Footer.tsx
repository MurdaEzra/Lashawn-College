  ...
  return <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* About */}
          <div>
            <h3 className="mb-4 text-xl font-bold text-[#2E8B57]">Lashawn</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/driving-courses" className="text-gray-300 hover:text-white">
                  Driving Courses
                </Link>
              </li>
              <li>
                <Link to="/computer-courses" className="text-gray-300 hover:text-white">
                  Computer Courses
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin size={20} className="mr-2 mt-1 flex-shrink-0 text-[#2E8B57]" />
                <span className="text-gray-300">
                  Along Eldoret Roadblock — Opposite Khetias Supermarket
                </span>
              </li>
              <li className="flex items-center">
                <Phone size={20} className="mr-2 flex-shrink-0 text-[#2E8B57]" />
                <a href="tel:+254117564318" className="text-gray-300 hover:text-white">
                  +254 117 564 318
                </a>
              </li>
              <li className="flex items-center">
                <Mail size={20} className="mr-2 flex-shrink-0 text-[#2E8B57]" />
                <a href="mailto:lashawnlimited@gmail.com" className="text-gray-300 hover:text-white">
